...
<!-- Mirrored from preview.colorlib.com/theme/courses/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Oct 2021 09:30:32 GMT -->
...
<head>
    ...
    <link rel="stylesheet"
        href="{{asset('frontend/assets/css/pp.css')}}" />
    <link rel="stylesheet" href="{{asset('frontend/assets/css/A.style.css.pagespeed.cf.LOwpVQvq3T.css')}}">
</head>
...
<body>
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-2">
                                <div class="logo">
                                    <a href="index-2.html"><img src="{{asset('frontend/assets/img/logo/logo.png')}}"
                                            alt=""></a>
                                </div>
                            </div>
    ...
    <main>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-8">
                        <div class="text-center section-tittle mb-55">
                ...
                <div class="courses-actives">
                    ...
                    <div class="pb-20 properties">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="{{asset('frontend/assets/img/gallery/featured1.png')}}"
                                        alt=""></a>
                            </div>
                    ...
                    <div class="pb-20 properties">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="{{asset('frontend/assets/img/gallery/featured2.png')}}"
                                        alt=""></a>
                            </div>
                            <div class="properties__caption">
                                <p>User Experience</p>
                    ...
                    <div class="pb-20 properties">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="{{asset('frontend/assets/img/gallery/featured3.png')}}"
                                        alt=""></a>
                            </div>
                            <div class="properties__caption">
                                <p>User Experience</p>
        ...
        <section class="pt-10 about-area1 fix">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="text-center single-topic mb-30">
                            <div class="topic-img">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="mt-20 text-center section-tittle">
        ...
        <section class="about-area3 fix">
            <div class="support-wrapper align-items-center">
                ...
                <div class="left-content3">
                    ...
                    <div class="mb-20 section-tittle section-tittle2">
                        <div class="front-text">
        ...
        <section class="team-area section-padding40 fix">
            <div class="container">
                ...
                <div class="team-active">
                    <div class="text-center single-cat">
                        <div class="cat-icon">
                ...
                <div class="container">
                    <div class="footer-border">
                        <div class="row d-flex align-items-center">
                            <div class="col-xl-12 ">
                                <div class="text-center footer-copy-right">
                                    <p>
    ...
    <script
        src="{{asset('frontend/assets/js/popper.min.js%2bbootstrap.min.js%2bjquery.slicknav.min.js.pagespeed.jc.FAxn3fLQIG.js')}}">
    </script>
    <script>
        eval(mod_pagespeed_rUezBy$u6W);
    </script>
    <script>
        eval(mod_pagespeed_I$bx5Sk0lL);
    </script>

    <script>
        eval(mod_pagespeed_0WmRPuy2R2);
    </script>

    <script src="{{asset('frontend/assets/js/owl.carousel.min.js%2bslick.min.js.pagespeed.jc.MvdZXrxw3E.js')}}">
    </script>
    <script>
        eval(mod_pagespeed_N24ecNEuU4);
    </script>
    <script>
        eval(mod_pagespeed_SSVDKaH1cu);
    </script>

    <script
        src="{{asset('frontend/assets/js/wow.min.js%2banimated.headline.js%2bjquery.magnific-popup.js.pagespeed.jc.Hw7kEqgrH-.js')}}">
    </script>
    <script>
        eval(mod_pagespeed_EbP84Shu0y);
    </script>
    <script>
        eval(mod_pagespeed_3V$oTPOrik);
    </script>
    <script>
        eval(mod_pagespeed_KdGKEH78VK);
    </script>

    <script src="{{asset('frontend/assets/js/gijgo.min.js')}}"></script>

    <script
        src="{{asset('frontend/assets/js/jquery.nice-select.min.js%2bjquery.sticky.js%2bjquery.barfiller.js%2bjquery.counterup.min.js%2bwaypoints.min.js%2bjquery.countdown.min.js%2bhover-direction-snake.min.js%2bco.js')}}">
    </script>
    <script>
        eval(mod_pagespeed_6gUGEOJ31E);
    </script>
    <script>
        eval(mod_pagespeed_RjnHLEP38B);
    </script>

    <script>
        eval(mod_pagespeed_Xfnp9KsDEX);
    </script>

    <script>
        eval(mod_pagespeed_4F$jy$gyWq);
    </script>
    <script>
        eval(mod_pagespeed_2A$OQkzSwQ);
    </script>
    <script>
        eval(mod_pagespeed__sJXrHhi9n);
    </script>
    <script>
        eval(mod_pagespeed_kaot9bSf9j);
    </script>

    <script>
        eval(mod_pagespeed_tQToAB2vCI);
    </script>
    <script>
        eval(mod_pagespeed_lAWOB2xCd3);
    </script>
    <script
        src="{{asset('frontend/assets/js/dd.js')}}">
    </script>
    <script>
        eval(mod_pagespeed_mZYG$KiyaO);
    </script>
    <script>
        eval(mod_pagespeed_LG9vi77dZ5);
    </script>
    <script>
        eval(mod_pagespeed_RReNCWy2Pv);
    </script>

    <script>
        eval(mod_pagespeed_QLgeFFTVuE);
    </script>
    <script>
        eval(mod_pagespeed_tS7A$rzoi_);
    </script>
</body>

<!-- Mirrored from preview.colorlib.com/theme/courses/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Oct 2021 09:30:49 GMT -->
